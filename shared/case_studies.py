...
CASE_STUDIES = {
    ...
    "pulse_oximeter_bias": CaseStudy(
        ...
        summary=(
            ...
            "absorption through tissue, and clinicians use the reading to "
            "triage patients and titrate supplemental oxygen. Researchers "
            "compared paired pulse-oximeter and arterial-blood-gas "
            "measurements taken within 10 minutes of each other, in adult "
            "inpatients at University of Michigan Hospital and separately "
            "in ICU patients across a multicenter database spanning about "
            "178 hospitals from 2014 to 2015. In both cohorts they tested "
            "for occult hypoxemia, an arterial oxygen saturation below 88% "
            "despite a pulse-oximeter reading of 92 to 96%. Occult hypoxemia "
            "occurred in 12% of measurements in Black patients versus 4% in "
            "White patients at the single center, and 17% versus 6% in the "
            "multicenter cohort, roughly three times as often in Black "
            "patients in each. Not every Black patient in the cohorts "
            "showed occult hypoxemia, so the disparity is a difference in "
            "rate, not a rule that applies to every individual."
        ),
        takeaway=(
            ...
            "and labels used to create the data. This measurement gap also "
            "shows how slowly a device-level bias can surface: pulse "
            "oximeters had been in routine clinical use for decades, and "
            "premarket testing guidance had asked for as few as two darkly "
            "pigmented subjects, before this study prompted the FDA to draft "
            "guidance in 2024 requesting far larger, skin-pigmentation-"
            "stratified validation samples. Regulatory subgroup-reporting "
            "requirements are a response to a measurement problem, not a "
            "substitute for checking it directly."
        ),
        citation=(
