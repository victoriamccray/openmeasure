...
from shared.report import section_header, caveat, flagged_item_note
...
if "pe_recommendation" in st.session_state:
    ...
    if run_clicked:
        ...
        try:
            ...
            elif method in ("compare_multiple_groups", "compare_multiple_groups_welch"):
                if method == "compare_multiple_groups_welch":
                    caveat(
                        "Welch's ANOVA with Games-Howell post-hoc is the recommended "
                        "method here but is not yet implemented. Falling back to "
                        "standard one-way ANOVA with Tukey HSD, which assumes equal "
