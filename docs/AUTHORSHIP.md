...
**Victoria McCray** — concept, design, and development of OpenMeasure,
including the Reliability module (v0.1) and the overall project structure,
design standards, and roadmap.

## Contributors

Contributions are welcome, see `CONTRIBUTING.md`. This section will list
contributors as pull requests are merged.

## Acknowledgments

The Reliability module's formulas and interpretation conventions draw on
